...
?>
    ...
    <div class="flex-grow-1 per-10 ourServicesMobile paddingM-30 d-none">
        ...
        <div class="owl-carousel owl-theme ourServicesMobileOwl">
            <div data-imgName="services6.jpg" class="item">
        ...
        <div class="ourServicesMobileDetailWrap">
            <img style="border-radius: 20px 20px 0 0" src="<?php bloginfo("template_directory"); ?>/images/services/services5.png" alt="">
            <div style="padding: 20px 25px">
                <h6 class="mServiceTitleDetail">UX Research and UX Design</h6>
    ...
    <script>
        $(document).ready(function (){
            ...
            $.each(firstSlide,function (index,value){
                $('.detailOurServicesOwl').trigger('add.owl.carousel', ['<div class="item eachSlideOurServices" style="background: url(../wp-content/themes/NXM/images/services/'+value+')"></div>'])
                ...
                // }else {
                    ...
                    var imgName = $(this).attr('data-imgSlide').split(",");
                        ...
                        $.each(imgName,function (i,v){
                            $('.detailOurServicesOwl').trigger('add.owl.carousel', ['<div class="item eachSlideOurServices" style="background: url(../wp-content/themes/NXM/images/services/'+v+')"></div>'])
                                .trigger('refresh.owl.carousel');
                        })
            ...
            $('.ourServicesMobile .item').click(function (){
                ...
                img.attr('src','../wp-content/themes/NXM/images/services/'+imgName)
            })
